...
namespace tte { namespace platform_layer {
    ...
    extern bool init();
    extern void deinit();
    extern Window* create_window(U32 width, U32 height);
    ...
    extern bool poll_events(Event&);
    extern void clear_buffer(Window& window, U8 r, U8 g, U8 b);
    extern void show_buffer(Window& window);
    extern Font* open_font(const char* path, U32 size);
    extern void close_font(Font& font);
    extern char get_key_code_character(KeyCode code);
    extern U32 get_cursor_x(Font& font, const char* line, U64 cursorIndex);
    extern Length get_fonts(platform_layer::Font** fonts, const U32 size);
}}
